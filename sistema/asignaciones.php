            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered" id="table">
                    ...
                    <tbody>
                        ...
                        $query = mysqli_query($conexion, "SELECT a.noasig, a.fecha, a.codemple,  emp.nombres, emp.apellidos 
                                                            FROM asignacion a
                                                            INNER JOIN empleados emp ON a.codemple = emp.id_empleado
                                                            ORDER BY a.noasig DESC");

                        $emp = mysqli_num_rows($query);
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="eliminar_asign.php?noasig=<?php echo $dato['noasig']; ?>" method="post" class="confirmar d-inline">
