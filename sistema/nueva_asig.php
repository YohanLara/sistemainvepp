                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <a href="#" class="btn btn-primary btn_new_cliente"><i class="fas fa-user-plus"></i> Nuevo Empleado</a>
                            </div>
                            <div class="card">
                                <div class="card-body">
                            ...
                            <h4 class="text-center">Datos Asignacion</h4>
                            <div class="row">
                                <div class="col-lg-6">
                                    <!-- <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div id="acciones_venta" class="form-group">
                                        ...
                                        <a href="#" class="btn btn-primary" id="btn_facturar_venta"><i class="fas fa-save"></i> Generar Asignacion</a>
                                    </div>
                                </div>
                            </div>
