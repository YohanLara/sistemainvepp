...
$pdf->Cell(25, 10, utf8_decode($row['codproducto']), 1, 0, 'C', 0);
...
$pdf->Cell(95, 10, utf8_decode($row['descripcion']), 1, 0, 'C', 0);
$pdf->Cell(35, 10, utf8_decode($row['cantidad']), 1, 0, 'C', 0);
$pdf->Cell(35, 10, utf8_decode($row['talla']), 1, 1, 'C', 0);
}
